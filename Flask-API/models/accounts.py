...
class AccountsModel(db.Model):
    ...
    orders = db.relationship('OrdersModel', backref=n.ACCS, lazy=True)
    ...
    def pay(self, price):
        self.available_money = self.available_money - price
    ...
    def return_all(cls):
        return {n.ACCS:
                    [a.json()[n.ACC] for a in AccountsModel.query.all()]
                }